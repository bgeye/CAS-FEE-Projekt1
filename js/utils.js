...
function save(e) {
    ...
    if (clickedBtn === 'submit') {
        ...
        if (getUrlId()) {
            const noteId = getUrlId();

            updateNote(noteTitle, noteDescription, noteImportance, noteDoneDate, noteFinished, noteId);
...
function updateNote(noteTitle, noteDescription, noteImportance, noteDoneDate, noteItemFinished = false, noteItemId) {
...
function createNote(noteTitle, noteDescription, noteImportance, noteDoneDate) {
    const newId = createNewId();
    const finished = false;
    const createDate = new String(Date.now());
